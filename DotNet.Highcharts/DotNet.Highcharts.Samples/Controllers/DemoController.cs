...
namespace DotNet.Highcharts.Samples.Controllers
{
    public class DemoController : Controller
    {
        ...
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart { Type = ChartTypes.Area, SpacingBottom = 30 })
                ...
                .SetPlotOptions(new PlotOptions { Area = new PlotOptionsArea { FillOpacity = 0.5 } })
                .SetCredits(new Credits { Enabled = false })
                .SetSeries(new[]
                {
        ...
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart { Type = ChartTypes.Area, Inverted = true })
        ...
        public ActionResult AreaRangeAndLine()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart())
        ...
        public ActionResult FixedPlacementColumns()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart { Type = ChartTypes.Column })
                .SetTitle(new Title { Text = "Efficiency Optimization by Branch" })
                .SetXAxis(new XAxis { Categories = new[] { "Seattle HQ", "San Francisco", "Tokyo" } })
                .SetYAxis(new[]
                {
                    new YAxis
                    {
                        Id = "1",
                        Min = 0,
                        Title = new YAxisTitle { Text = "Employees" }
                    },
                    new YAxis
                    {
                        Id = "2",
                        Opposite = true,
                        Title = new YAxisTitle { Text = "Profit (millions)" }
                    }
                })
                .SetLegend(new Legend { Shadow = false })
                .SetTooltip(new Tooltip { Shared = true })
                .SetPlotOptions(new PlotOptions
                {
                    Column = new PlotOptionsColumn
                ...
                .SetSeries(new[]
                {
                    ...
                    {
                        Name = "Employees",
                        Color = Color.FromArgb(255, 165, 170, 217),
                        Data = new Data(new object[] { 150, 73, 20 }),
                        PlotOptionsColumn = new PlotOptionsColumn
                        {
                            PointPadding = 0.3,
                            PointPlacement = new PointPlacement(-0.2)
                        }
                    },
                    new Series
                    {
                        Name = "Employees Optimized",
                        Color = Color.FromArgb(230, 126, 86, 134),
                        Data = new Data(new object[] { 140, 90, 40 }),
                        PlotOptionsColumn = new PlotOptionsColumn
                        {
                            PointPadding = 0.4,
                            PointPlacement = new PointPlacement(-0.2)
                    ...
                    {
                        Name = "Profit",
                        Color = Color.FromArgb(255, 248, 161, 63),
                        Data = new Data(new object[] { 183.6, 178.8, 198.5 }),
                        YAxis = "1",
                        PlotOptionsColumn = new PlotOptionsColumn
                        {
                            Tooltip = new PlotOptionsColumnTooltip
                            {
                                ValuePrefix = "$",
                                ValueSuffix = " M"
                            },
                    ...
                    {
                        Name = "Profit",
                        Color = Color.FromArgb(230, 186, 60, 61),
                        Data = new Data(new object[] { 203.6, 198.8, 208.5 }),
                        YAxis = "1",
                        PlotOptionsColumn = new PlotOptionsColumn
                        {
                            Tooltip = new PlotOptionsColumnTooltip
        ...
        public ActionResult PieWithMonochromeFill()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart { PlotBackgroundColor = null, PlotBorderWidth = null, PlotShadow = false })
        ...
        public ActionResult DonutChart()
        {
            ...
            {
                browserData.Add(new Point { Name = categories[i], Y = data.Points[i].Y, Color = data.Points[i].Color });
                for (int j = 0; j < data.Points[i].Drilldown.Categories.Length; j++)
                {
                    PointDrilldown drilldown = data.Points[i].Drilldown;
        ...
        public ActionResult SemiCircleDonut()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart { PlotBorderWidth = 0, PlotShadow = false })
                .SetTitle(new Title { Text = "Browser<br>shares", Align = HorizontalAligns.Center, VerticalAlign = VerticalAligns.Middle, Y = 50 })
        ...
        public ActionResult SolidGauge()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart { Type = ChartTypes.Solidgauge })
                .SetTitle(new Title { Text = "" })
                .SetPane(new Pane
                {
                    Center = new [] { new PercentageOrPixel(50, true), new PercentageOrPixel(85, true) },
                    Size = new PercentageOrPixel(140, true),
                    StartAngle = -90,
                    EndAngle = 90,
                    Background = new[] 
                    { 
                ...
                .SetYAxis(new YAxis
                {
                    ...
                    Min = 0,
                    Max = 200,
                    Title = new YAxisTitle { Text = "Speed"},
                    Stops = new Gradient
                    {
                        Stops = new object[,]
                        {
            ...
            Highcharts chart = new Highcharts("chart")
                ...
                .SetPlotOptions(new PlotOptions
                {
                    ...
                    Column = new PlotOptionsColumn
                    {
                        PointPadding = 0,
                        GroupPadding = 0,
                        PointPlacement = new PointPlacement(Placement.Between)
                    }
                })
                .SetSeries(new[]
                {
            ...
            Highcharts chart = new Highcharts("chart")
                ...
                .SetSeries(new[]
                {
                    new Series
                    {
                        ...
                        PlotOptionsLine = new PlotOptionsLine { PointPlacement = new PointPlacement(Placement.On) }
                    },
                    new Series
                    {
        ...
        public ActionResult ThreeDColumn()
        {
            Highcharts chart = new Highcharts("chart")
                ...
                .SetLegend(new Legend { Enabled = false })
                .SetSeries(new Series { Data = new Data(new object[] { 29.9, 71.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 95.6, 54.4 }) });
            
            return View(chart);
        }

        public ActionResult ThreeDColumnWithNullAndZeroValues()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart
                {
                ...
                .SetTitle(new Title { Text = "3D chart with null values" })
                .SetSubtitle(new Subtitle { Text = "Notice the difference between a 0 value and a null point" })
                .SetPlotOptions(new PlotOptions { Column = new PlotOptionsColumn { Depth = 25 } })
                .SetXAxis(new XAxis { Categories = CultureInfo.CurrentCulture.DateTimeFormat.AbbreviatedMonthNames })
                .SetYAxis(new YAxis { Opposite = true})
                .SetSeries(new Series { Data = new Data(new object[] { 2, 3, null, 4, 0, 5, 1, 4, 6, 3 }) });

            return View(chart);
        }

        public ActionResult ThreeDColumnWithStackingAndGrouping()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart
                {
                ...
                .SetTitle(new Title { Text = "Total fruit consumption, grouped by gender" })
                .SetPlotOptions(new PlotOptions { Column = new PlotOptionsColumn { Stacking = Stackings.Normal, Depth = 25 } })
                .SetXAxis(new XAxis { Categories = new []{"Apples", "Oranges", "Pears", "Grapes", "Bananas"} })
                .SetYAxis(new YAxis
                {
                    AllowDecimals = false,
                ...
                .SetSeries(new[]
                {
                    new Series { Name = "John", Stack = "male", Data = new Data(new object[] { 5, 3, 4, 7, 2 }) },
                    new Series { Name = "Joe", Stack = "male", Data = new Data(new object[] { 3, 4, 4, -2, 5 }) },
                    new Series { Name = "Jane", Stack = "female", Data = new Data(new object[] { 2, 5, 6, 2, 1 }) },
                    new Series { Name = "Janet", Stack = "female", Data = new Data(new object[] { 3, 0, 4, 4, 3 }) }
                });

            return View(chart);
        }

        public ActionResult ThreeDPie()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart
                {
                ...
                .SetTitle(new Title { Text = "Browser market shares at a specific website, 2014" })
                .SetTooltip(new Tooltip { PointFormat = "{series.name}: <b>{point.percentage:.1f}%</b>" })
                .SetPlotOptions(new PlotOptions { Pie = new PlotOptionsPie
                {
                    AllowPointSelect = true,
                    Cursor = Cursors.Pointer,
                    Depth = 35,
        ...
        public ActionResult ThreeDDonut()
        {
            Highcharts chart = new Highcharts("chart")
                .InitChart(new Chart
                {
                ...
                .SetTitle(new Title { Text = "Contents of Highsoft\\\'s weekly fruit delivery" })
                .SetSubtitle(new Subtitle { Text = "3D donut in Highcharts" })
                .SetPlotOptions(new PlotOptions
                {
                    Pie = new PlotOptionsPie
                    {
                ...
                .SetSeries(new Series
                {
                    ...
                    Data = new Data(new object[]
                    {
                        new object[] { "Bananas", 8 },
                        new object[] { "Kiwi", 3 },
                        new object[] { "Mixed nuts", 1 },
                        new object[] { "Oranges", 6 },
                        new object[] { "Apples", 8 },
                        new object[] { "Pears", 4 },
                        new object[] { "Clementines", 4 },
                        new object[] { "Reddish (bag)", 1 },
                        new object[] { "Grapes (bunch)", 1 }
                    })
                });
