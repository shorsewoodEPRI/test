...
namespace DotNet.Highcharts.Options
{
	public class YAxisTitle
	{
        ...
        /// <summary>
        /// EPRI added :: The x position of the title relative to the alignment within chart.spacingLeft and chart.spacingRight.
        /// Default: 0
        /// </summary>
        public Number? X { get; set; }

        /// <summary>
        /// EPRI added :: The y position of the title relative to the alignment within <a href='#chart.spacingTop'>chart.spacingTop</a> and <a href='#chart.spacingBottom'>chart.spacingBottom</a>. By default it depends on the font size.
        /// </summary>
